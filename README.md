...
- **Evaluation Runs**: In an ideal setting, the evaluation metrics should be averaged over 3 or more repetitions. But there were so many experiments in Table 1 that I ran out of resources to do so. This sort of averaging might be feasible if you are working just with multi-task models. 
